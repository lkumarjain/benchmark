...
import (
	...
	cache "github.com/floatdrop/slru"
)

func BenchmarkFloatdropSLRU(b *testing.B) {
	for _, tt := range tests {
		benchmarkFloatdropSLRU(b, tt.name, tt.valueGenerator)
	}
}

func benchmarkFloatdropSLRU(b *testing.B, prefix string, valueGenerator func(int) string) {
